...
import { Search, Eye, Edit, Plus, ArrowUpDown, ShoppingCart } from 'lucide-react';
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400 mt-1">
              จัดการคำสั่งซื้อทั้งหมดในระบบ {pagination && `(${pagination.total.toLocaleString('th-TH')} รายการ)`}
            </p>
          </div>
          <button
