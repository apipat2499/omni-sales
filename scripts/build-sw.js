...
const swPath = path.join(__dirname, '../public/service-worker.ts');
const swContent = fs.readFileSync(swPath, 'utf-8');

// For now, we'll create a simplified version that doesn't use Workbox
// In production, you would use a proper TypeScript compiler or webpack
const jsContent = `
...
// Write the compiled service worker
const outputPath = path.join(__dirname, '../public/sw.js');
fs.writeFileSync(outputPath, jsContent);

console.log('[Build SW] Service worker built successfully:', outputPath);
