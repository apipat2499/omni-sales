...
- 🏷️ **Discounts & Promotions** - ส่วนลดและโปรโมชั่น **[NEW]**
  - สร้างโค้ดส่วนลด (Percentage หรือ Fixed Amount)
  - กำหนดยอดซื้อขั้นต่ำ
  - จำกัดจำนวนการใช้งาน
  - กำหนดวันเริ่มต้น-สิ้นสุด
  - ตรวจสอบความถูกต้องของโค้ดส่วนลด
  - แสดงสถิติการใช้งาน
- 🔔 **Notification Center** - ศูนย์การแจ้งเตือน **[NEW]**
  - แจ้งเตือนคำสั่งซื้อใหม่
  - แจ้งเตือนสต็อกเหลือน้อย
  - แจ้งเตือนสินค้าหมดสต็อก
  - ระบบแจ้งเตือนแบบ Real-time
  - ทำเครื่องหมายอ่าน/ไม่อ่าน
- 📧 **Email Notifications** - ระบบอีเมลอัตโนมัติ **[NEW]**
  - อีเมลยืนยันคำสั่งซื้อ
  - อีเมลแจ้งสถานะการจัดส่ง
  - อีเมลแจ้งเตือนสต็อก (ส่งถึง Admin)
  - Email templates สวยงามรองรับ Dark Mode
  - ปรับแต่งการตั้งค่าการรับอีเมลได้
- ⚙️ **Settings** - การตั้งค่า
  - ตั้งค่าโปรไฟล์
  - ตั้งค่าข้อมูลธุรกิจ
  - ตั้งค่าการแจ้งเตือนและอีเมล **[UPDATED]**
  - เกณฑ์การแจ้งเตือนสต็อกต่ำ
  - ตั้งค่าความปลอดภัย
  - ตั้งค่ารูปแบบ
