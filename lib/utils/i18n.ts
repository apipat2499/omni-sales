...
export const translations = {
  th: {
    ...
    'warehouse.title': 'คลังสินค้า',
    'warehouse.dashboard.subtitle': 'จัดการคลังสินค้าและสถานที่เก็บ',
    'warehouse.createWarehouse': 'สร้างคลังสินค้าใหม่',
    'warehouse.name': 'ชื่อคลังสินค้า',
    'warehouse.code': 'รหัสคลังสินค้า',
    'warehouse.type': 'ประเภท',
    'warehouse.address': 'ที่อยู่',
    'warehouse.capacity': 'ความจุ',
    'warehouse.utilization': 'การใช้งาน',
    'warehouse.active': 'ใช้งาน',
    'warehouse.inactive': 'ไม่ใช้งาน',
    'warehouse.status': 'สถานะ',
    'warehouse.locations': 'สถานที่เก็บ',
    'warehouse.inventory': 'สินค้าคงคลัง',
    'warehouse.zones': 'โซน',
    'warehouse.zone': 'โซน',
    'warehouse.search': 'ค้นหาคลังสินค้า',
    'warehouse.noWarehouses': 'ไม่มีคลังสินค้า',
    'warehouse.createFirst': 'สร้างคลังสินค้าแรก',
    'warehouse.totalSlots': 'ช่องทั้งหมด',
    'warehouse.usedSlots': 'ช่องที่ใช้',
    'warehouse.inventoryValue': 'มูลค่าสินค้าคงคลัง',
    'warehouse.empty': 'ว่าง',
    'warehouse.occupied': 'มีสินค้า',
    'warehouse.operatingHours': 'เวลาทำการ',
    'warehouse.hours': 'เวลา',
    'warehouse.timezone': 'เขตเวลา',
    'warehouse.basicInfo': 'ข้อมูลพื้นฐาน',
    'warehouse.recentActivity': 'กิจกรรมล่าสุด',
    'warehouse.noRecentActivity': 'ไม่มีกิจกรรมล่าสุด',
    'warehouse.gridView': 'มุมมองตาราง',
    'warehouse.listView': 'มุมมองรายการ',
    'warehouse.mapViewComingSoon': 'มุมมองแผนที่กำลังจะมาเร็วๆ นี้',
    'warehouse.product': 'สินค้า',
    'warehouse.totalQty': 'จำนวนรวม',
    'warehouse.available': 'พร้อมใช้งาน',
    'warehouse.reserved': 'จอง',
    'warehouse.inTransit': 'ขนส่งระหว่างทาง',
    'warehouse.noMetrics': 'ไม่มีข้อมูลเมตริก',
    'warehouse.staff': 'พนักงาน',
    'warehouse.managers': 'ผู้จัดการ',
    'warehouse.type.primary': 'หลัก',
    'warehouse.type.secondary': 'รอง',
    'warehouse.type.regional': 'ภูมิภาค',
    'warehouse.type.popup': 'ชั่วคราว',
    'warehouse.status.healthy': 'สุขภาพดี',
    'warehouse.status.warning': 'เตือน',
    'warehouse.status.critical': 'วิกฤติ',
    'warehouse.stats.totalWarehouses': 'คลังสินค้าทั้งหมด',
    'warehouse.stats.totalInventory': 'สินค้าคงคลังรวม',
    'warehouse.stats.avgUtilization': 'การใช้งานเฉลี่ย',
    'warehouse.stats.lowStock': 'สินค้าเหลือน้อย',
    'warehouse.filter.allTypes': 'ทุกประเภท',
    'warehouse.sort.name': 'ชื่อ',
    'warehouse.sort.utilization': 'การใช้งาน',
    'warehouse.sort.inventory': 'สินค้าคงคลัง',
    'warehouse.sort.product': 'สินค้า',
    'warehouse.sort.quantity': 'จำนวน',
    'warehouse.sort.available': 'พร้อมใช้งาน',
    'warehouse.alerts.title': 'การแจ้งเตือน',
    'warehouse.alerts.lowStockItems': 'รายการสินค้าเหลือน้อย',
    'warehouse.alerts.pendingTransfers': 'การโอนที่รอดำเนินการ',
    'warehouse.detail.utilization': 'การใช้งาน',
    'warehouse.detail.locations': 'สถานที่เก็บ',
    'warehouse.detail.inventoryItems': 'รายการสินค้า',
    'warehouse.detail.lowStockItems': 'สินค้าเหลือน้อย',
    'warehouse.tab.overview': 'ภาพรวม',
    'warehouse.tab.locations': 'สถานที่เก็บ',
    'warehouse.tab.inventory': 'สินค้าคงคลัง',
    'warehouse.tab.zones': 'โซน',
    'warehouse.tab.staff': 'พนักงาน',
    'warehouse.tab.metrics': 'เมตริก',
    'warehouse.metrics.utilization': 'การใช้งาน',
    'warehouse.metrics.accuracy': 'ความแม่นยำ',
    'warehouse.metrics.throughput': 'ปริมาณงาน',
    'warehouse.location.title': 'จัดการสถานที่เก็บ',
    'warehouse.location.create': 'สร้างสถานที่เก็บใหม่',
    'warehouse.location.search': 'ค้นหาสถานที่เก็บ',
    'warehouse.location.barcode': 'บาร์โค้ด',
    'warehouse.location.position': 'ตำแหน่ง',
    'warehouse.location.status': 'สถานะ',
    'warehouse.location.stock': 'สต๊อก',
    'warehouse.location.aisle': 'ทางเดิน',
    'warehouse.location.shelf': 'ชั้น',
    'warehouse.location.bin': 'ช่อง',
    'warehouse.location.zones': 'โซน',
    'warehouse.location.locations': 'สถานที่เก็บ',
    'warehouse.location.barcodes': 'บาร์โค้ด',
    'warehouse.location.noLocations': 'ไม่มีสถานที่เก็บ',
    'warehouse.location.createFirst': 'สร้างสถานที่เก็บแรก',
    'warehouse.zone.all': 'ทุกโซน',
    'warehouse.zone.create': 'สร้างโซนใหม่',
    'warehouse.zone.noZones': 'ไม่มีโซน',
    'warehouse.zone.createFirst': 'สร้างโซนแรก',
    'warehouse.zone.aisles': 'ทางเดิน',
    'warehouse.barcode.generator': 'เครื่องสร้างบาร์โค้ด',
    'warehouse.barcode.generate': 'สร้างบาร์โค้ด',
    'warehouse.barcode.generated': 'บาร์โค้ดที่สร้าง',
    'warehouse.barcode.list': 'รายการบาร์โค้ด',
    'warehouse.allocation.title': 'การจัดสรรสินค้า',
    'warehouse.allocation.subtitle': 'จัดสรรสินค้าไปยังคลังสินค้าด้วยอัลกอริทึมที่ฉลาด',
    'warehouse.allocation.testAllocation': 'ทดสอบการจัดสรร',
    'warehouse.allocation.algorithm': 'อัลกอริทึม',
    'warehouse.allocation.customerLocation': 'ตำแหน่งลูกค้า',
    'warehouse.allocation.latitude': 'ละติจูด',
    'warehouse.allocation.longitude': 'ลองจิจูด',
    'warehouse.allocation.result': 'ผลการจัดสรร',
    'warehouse.allocation.status': 'สถานะ',
    'warehouse.allocation.unallocated': 'ไม่สามารถจัดสรร',
    'warehouse.allocation.noResult': 'ยังไม่มีผลการจัดสรร',
    'warehouse.allocation.rules': 'กฎการจัดสรร',
    'warehouse.allocation.priority': 'ลำดับความสำคัญ',
    'warehouse.allocation.error.noItems': 'กรุณาเพิ่มรายการสินค้า',
    'warehouse.allocation.algorithm.nearest': 'ใกล้ที่สุด',
    'warehouse.allocation.algorithm.inventory': 'ตามสินค้าคงคลัง',
    'warehouse.allocation.algorithm.cost': 'ประหยัดต้นทุน',
    'warehouse.allocation.algorithm.hybrid': 'ผสมผสาน',
    'warehouse.allocation.tab.allocation': 'การจัดสรร',
    'warehouse.allocation.tab.transfers': 'การโอน',
    'warehouse.allocation.tab.forecast': 'การพยากรณ์',
    'warehouse.allocation.tab.rebalancing': 'การปรับสมดุล',
    'warehouse.transfers.all': 'ทั้งหมด',
    'warehouse.transfers.pending': 'รอดำเนินการ',
    'warehouse.transfers.inTransit': 'ระหว่างขนส่ง',
    'warehouse.transfers.received': 'รับแล้ว',
    'warehouse.transfers.from': 'จาก',
    'warehouse.transfers.to': 'ไปยัง',
    'warehouse.transfers.items': 'รายการ',
    'warehouse.transfers.ship': 'จัดส่ง',
    'warehouse.transfers.markReceived': 'ทำเครื่องหมายว่าได้รับแล้ว',
    'warehouse.transfers.pendingDescription': 'การโอนเหล่านี้ต้องดำเนินการ',
    'warehouse.forecast.title': 'การพยากรณ์ความต้องการ',
    'warehouse.forecast.comingSoon': 'กำลังจะมาเร็วๆ นี้',
    'warehouse.rebalancing.title': 'การปรับสมดุลสินค้าคงคลัง',
    'warehouse.rebalancing.createPlan': 'สร้างแผนการปรับสมดุล',
    'warehouse.rebalancing.transfers': 'การโอน',
    'warehouse.rebalancing.estimatedCost': 'ต้นทุนประมาณ',
    'warehouse.rebalancing.improvement': 'การปรับปรุง',
    'warehouse.rebalancing.execute': 'ดำเนินการ',
    'warehouse.rebalancing.noPlan': 'ยังไม่มีแผนการปรับสมดุล',
    'common.refresh': 'รีเฟรช',

    // Fulfillment
    'fulfillment.title': 'การจัดการการจัดส่ง',
    'fulfillment.dashboard': 'แดชบอร์ดจัดส่ง',
    'fulfillment.dashboardDescription': 'จัดการการหยิบสินค้า แพ็ค และจัดส่ง',
    'fulfillment.order': 'ออเดอร์',
    'fulfillment.orders': 'ออเดอร์',
    'fulfillment.items': 'รายการ',
    'fulfillment.location': 'สถานที่',
    'fulfillment.product': 'สินค้า',
    'fulfillment.assignedTo': 'มอบหมายให้',
    'fulfillment.priority': 'ลำดับความสำคัญ',
    'fulfillment.noOrders': 'ไม่มีออเดอร์',
    'fulfillment.searchPlaceholder': 'ค้นหาออเดอร์, สินค้า...',
    'fulfillment.statusOverview': 'ภาพรวมสถานะ',
    'fulfillment.totalOrders': 'ออเดอร์ทั้งหมด',
    'fulfillment.ordersSummary': 'สรุปออเดอร์',
    'fulfillment.pickingList': 'รายการหยิบสินค้า',
    'fulfillment.shippingManager': 'จัดการการจัดส่ง',
    'fulfillment.startPicking': 'เริ่มหยิบสินค้า',
    'fulfillment.startPacking': 'เริ่มแพ็ค',
    'fulfillment.ship': 'จัดส่ง',
    'fulfillment.pickedBy': 'หยิบโดย',
    'fulfillment.picked': 'หยิบแล้ว',
    'fulfillment.pick': 'หยิบ',
    'fulfillment.completePicking': 'เสร็จสิ้นการหยิบ',
    'fulfillment.pickingNotes': 'บันทึกการหยิบ',
    'fulfillment.addNotes': 'เพิ่มบันทึก',
    'fulfillment.barcodeScanner': 'สแกนบาร์โค้ด',
    'fulfillment.scanBarcode': 'สแกนบาร์โค้ด...',

    // Fulfillment Status
    'fulfillment.status.new': 'ใหม่',
    'fulfillment.status.payment_received': 'รับชำระเงินแล้ว',
    'fulfillment.status.readyForFulfillment': 'พร้อมจัดส่ง',
    'fulfillment.status.picking': 'กำลังหยิบ',
    'fulfillment.status.picked': 'หยิบเสร็จแล้ว',
    'fulfillment.status.packing': 'กำลังแพ็ค',
    'fulfillment.status.packed': 'แพ็คเสร็จแล้ว',
    'fulfillment.status.shipped': 'จัดส่งแล้ว',
    'fulfillment.status.inTransit': 'อยู่ระหว่างขนส่ง',
    'fulfillment.status.outForDelivery': 'กำลังจัดส่ง',
    'fulfillment.status.delivered': 'ส่งถึงแล้ว',
    'fulfillment.status.returned': 'คืนสินค้า',
    'fulfillment.status.cancelled': 'ยกเลิก',

    // Fulfillment Priority
    'fulfillment.priority.urgent': 'ด่วนมาก',
    'fulfillment.priority.high': 'สูง',
    'fulfillment.priority.normal': 'ปกติ',
    'fulfillment.priority.low': 'ต่ำ',

    // Fulfillment Metrics
    'fulfillment.metrics.totalOrders': 'ออเดอร์ทั้งหมด',
    'fulfillment.metrics.averagePickTime': 'เวลาหยิบเฉลี่ย',
    'fulfillment.metrics.pickAccuracy': 'ความแม่นยำในการหยิบ',
    'fulfillment.metrics.onTimeShipment': 'จัดส่งตรงเวลา',

    // Fulfillment Sort
    'fulfillment.sortBy.priority': 'ลำดับความสำคัญ',
    'fulfillment.sortBy.date': 'วันที่',
    'fulfillment.sortBy.status': 'สถานะ',

    // Fulfillment Picking
    'fulfillment.picking.barcodeNotFound': 'ไม่พบบาร์โค้ด',

    // Shipping
    'fulfillment.shipping.fromAddress': 'จากที่อยู่',
    'fulfillment.shipping.toAddress': 'ถึงที่อยู่',
    'fulfillment.shipping.packageDetails': 'รายละเอียดพัสดุ',
    'fulfillment.shipping.weight': 'น้ำหนัก',
    'fulfillment.shipping.dimensions': 'ขนาด',
    'fulfillment.shipping.boxes': 'กล่อง',
    'fulfillment.shipping.rates': 'อัตราค่าส่ง',
    'fulfillment.shipping.refreshRates': 'รีเฟรชอัตรา',
    'fulfillment.shipping.noRates': 'ไม่มีอัตราค่าส่ง',
    'fulfillment.shipping.estimatedDelivery': 'การจัดส่งโดยประมาณ',
    'fulfillment.shipping.guaranteed': 'รับประกัน',
    'fulfillment.shipping.insuranceAvailable': 'มีประกันภัย',
    'fulfillment.shipping.options': 'ตัวเลือก',
    'fulfillment.shipping.insurance': 'ประกันภัย',
    'fulfillment.shipping.insuranceAmount': 'จำนวนเงินประกัน',
    'fulfillment.shipping.signatureRequired': 'ต้องลงนาม',
    'fulfillment.shipping.saturdayDelivery': 'จัดส่งวันเสาร์',
    'fulfillment.shipping.generateLabel': 'สร้างฉลาก',
    'fulfillment.shipping.generatingLabel': 'กำลังสร้างฉลาก...',
    'fulfillment.shipping.labelGenerated': 'สร้างฉลากแล้ว',
    'fulfillment.shipping.trackingNumber': 'หมายเลขติดตาม',
    'fulfillment.shipping.downloadLabel': 'ดาวน์โหลดฉลาก',
    'fulfillment.shipping.schedulePickup': 'กำหนดการรับสินค้า',
    'fulfillment.shipping.pickupDate': 'วันที่รับสินค้า',
    'fulfillment.shipping.pickupScheduled': 'กำหนดการรับสินค้าแล้ว',
    'fulfillment.shipping.confirmationNumber': 'หมายเลขยืนยัน',
    'fulfillment.shipping.markAsShipped': 'ทำเครื่องหมายว่าจัดส่งแล้ว',
    'fulfillment.shipping.labelGenerationError': 'เกิดข้อผิดพลาดในการสร้างฉลาก',
    'fulfillment.shipping.pickupSchedulingError': 'เกิดข้อผิดพลาดในการกำหนดการรับสินค้า',

    // Tracking
    'fulfillment.tracking.title': 'ติดตามพัสดุ',
    'fulfillment.tracking.trackingNumber': 'หมายเลขติดตาม',
    'fulfillment.tracking.lastUpdated': 'อัปเดตล่าสุด',
    'fulfillment.tracking.progress': 'ความคืบหน้า',
    'fulfillment.tracking.estimatedDelivery': 'การจัดส่งโดยประมาณ',
    'fulfillment.tracking.timeline': 'ไทม์ไลน์',
    'fulfillment.tracking.noEvents': 'ไม่มีเหตุการณ์',
    'fulfillment.tracking.map': 'แผนที่',
    'fulfillment.tracking.mapPlaceholder': 'แผนที่การจัดส่ง',
    'fulfillment.tracking.mapComingSoon': 'เร็วๆ นี้',
    'fulfillment.tracking.proofOfDelivery': 'หลักฐานการจัดส่ง',
    'fulfillment.tracking.deliveredAt': 'จัดส่งเมื่อ',
    'fulfillment.tracking.deliveryLocation': 'สถานที่จัดส่ง',
    'fulfillment.tracking.signatureOnFile': 'มีลายเซ็นในระบบ',
    'fulfillment.tracking.exception': 'มีปัญหา',
    'fulfillment.tracking.exceptionDetails': 'เกิดปัญหาในการจัดส่ง กรุณาติดต่อฝ่ายสนับสนุน',
    'fulfillment.tracking.contactSupport': 'ติดต่อฝ่ายสนับสนุน',
    'fulfillment.tracking.shareTracking': 'แชร์การติดตาม',

    // Tracking Status
    'fulfillment.tracking.status.pre_transit': 'รอจัดส่ง',
    'fulfillment.tracking.status.in_transit': 'อยู่ระหว่างขนส่ง',
    'fulfillment.tracking.status.out_for_delivery': 'กำลังจัดส่ง',
    'fulfillment.tracking.status.delivered': 'ส่งถึงแล้ว',
    'fulfillment.tracking.status.returned': 'คืนสินค้า',
    'fulfillment.tracking.status.exception': 'มีปัญหา',
    'fulfillment.tracking.status.cancelled': 'ยกเลิก',

    // Returns
    'returns.title': 'คืนสินค้า',
    'returns.reason': 'เหตุผล',
    'returns.status': 'สถานะ',
    'returns.requested': 'ขอคืน',
    'returns.approved': 'อนุมัติ',
    'returns.rejected': 'ปฏิเสธ',
    'returns.received': 'รับแล้ว',
    'returns.processed': 'ดำเนินการแล้ว',
  },
  ...
  en: {
    ...
    'warehouse.dashboard.subtitle': 'Manage warehouses and storage locations',
    'warehouse.createWarehouse': 'Create Warehouse',
    ...
    'warehouse.noWarehouses': 'No warehouses',
    'warehouse.createFirst': 'Create first warehouse',
    'warehouse.totalSlots': 'Total Slots',
    'warehouse.usedSlots': 'Used Slots',
    'warehouse.inventoryValue': 'Inventory Value',
    'warehouse.empty': 'Empty',
    'warehouse.occupied': 'Occupied',
    'warehouse.operatingHours': 'Operating Hours',
    'warehouse.hours': 'Hours',
    'warehouse.timezone': 'Timezone',
    'warehouse.basicInfo': 'Basic Information',
    'warehouse.recentActivity': 'Recent Activity',
    'warehouse.noRecentActivity': 'No recent activity',
    'warehouse.gridView': 'Grid View',
    'warehouse.listView': 'List View',
    'warehouse.mapViewComingSoon': 'Map view coming soon',
    'warehouse.product': 'Product',
    'warehouse.totalQty': 'Total Qty',
    'warehouse.available': 'Available',
    'warehouse.reserved': 'Reserved',
    'warehouse.inTransit': 'In Transit',
    'warehouse.noMetrics': 'No metrics available',
    'warehouse.staff': 'Staff',
    'warehouse.managers': 'Managers',
    'warehouse.type.primary': 'Primary',
    'warehouse.type.secondary': 'Secondary',
    'warehouse.type.regional': 'Regional',
    'warehouse.type.popup': 'Pop-up',
    'warehouse.status.healthy': 'Healthy',
    'warehouse.status.warning': 'Warning',
    'warehouse.status.critical': 'Critical',
    'warehouse.stats.totalWarehouses': 'Total Warehouses',
    'warehouse.stats.totalInventory': 'Total Inventory',
    'warehouse.stats.avgUtilization': 'Avg Utilization',
    'warehouse.stats.lowStock': 'Low Stock',
    'warehouse.filter.allTypes': 'All Types',
    'warehouse.sort.name': 'Name',
    'warehouse.sort.utilization': 'Utilization',
    'warehouse.sort.inventory': 'Inventory',
    'warehouse.sort.product': 'Product',
    'warehouse.sort.quantity': 'Quantity',
    'warehouse.sort.available': 'Available',
    'warehouse.alerts.title': 'Alerts',
    'warehouse.alerts.lowStockItems': 'low stock items',
    'warehouse.alerts.pendingTransfers': 'pending transfers',
    'warehouse.detail.utilization': 'Utilization',
    'warehouse.detail.locations': 'Locations',
    'warehouse.detail.inventoryItems': 'Inventory Items',
    'warehouse.detail.lowStockItems': 'Low Stock Items',
    'warehouse.tab.overview': 'Overview',
    'warehouse.tab.locations': 'Locations',
    'warehouse.tab.inventory': 'Inventory',
    'warehouse.tab.zones': 'Zones',
    'warehouse.tab.staff': 'Staff',
    'warehouse.tab.metrics': 'Metrics',
    'warehouse.metrics.utilization': 'Utilization',
    'warehouse.metrics.accuracy': 'Accuracy',
    'warehouse.metrics.throughput': 'Throughput',
    'warehouse.location.title': 'Location Management',
    'warehouse.location.create': 'Create Location',
    'warehouse.location.search': 'Search locations',
    'warehouse.location.barcode': 'Barcode',
    'warehouse.location.position': 'Position',
    'warehouse.location.status': 'Status',
    'warehouse.location.stock': 'Stock',
    'warehouse.location.aisle': 'Aisle',
    'warehouse.location.shelf': 'Shelf',
    'warehouse.location.bin': 'Bin',
    'warehouse.location.zones': 'Zones',
    'warehouse.location.locations': 'Locations',
    'warehouse.location.barcodes': 'Barcodes',
    'warehouse.location.noLocations': 'No locations',
    'warehouse.location.createFirst': 'Create first location',
    'warehouse.zone.all': 'All Zones',
    'warehouse.zone.create': 'Create Zone',
    'warehouse.zone.noZones': 'No zones',
    'warehouse.zone.createFirst': 'Create first zone',
    'warehouse.zone.aisles': 'Aisles',
    'warehouse.barcode.generator': 'Barcode Generator',
    'warehouse.barcode.generate': 'Generate Barcode',
    'warehouse.barcode.generated': 'Generated Barcode',
    'warehouse.barcode.list': 'Barcode List',
    'warehouse.allocation.title': 'Inventory Allocation',
    'warehouse.allocation.subtitle': 'Allocate inventory to warehouses with smart algorithms',
    'warehouse.allocation.testAllocation': 'Test Allocation',
    'warehouse.allocation.algorithm': 'Algorithm',
    'warehouse.allocation.customerLocation': 'Customer Location',
    'warehouse.allocation.latitude': 'Latitude',
    'warehouse.allocation.longitude': 'Longitude',
    'warehouse.allocation.result': 'Allocation Result',
    'warehouse.allocation.status': 'Status',
    'warehouse.allocation.unallocated': 'Unallocated',
    'warehouse.allocation.noResult': 'No allocation result yet',
    'warehouse.allocation.rules': 'Allocation Rules',
    'warehouse.allocation.priority': 'Priority',
    'warehouse.allocation.error.noItems': 'Please add items',
    'warehouse.allocation.algorithm.nearest': 'Nearest',
    'warehouse.allocation.algorithm.inventory': 'Inventory-based',
    'warehouse.allocation.algorithm.cost': 'Cost-optimized',
    'warehouse.allocation.algorithm.hybrid': 'Hybrid',
    'warehouse.allocation.tab.allocation': 'Allocation',
    'warehouse.allocation.tab.transfers': 'Transfers',
    'warehouse.allocation.tab.forecast': 'Forecast',
    'warehouse.allocation.tab.rebalancing': 'Rebalancing',
    'warehouse.transfers.all': 'All',
    'warehouse.transfers.pending': 'Pending',
    'warehouse.transfers.inTransit': 'In Transit',
    'warehouse.transfers.received': 'Received',
    'warehouse.transfers.from': 'From',
    'warehouse.transfers.to': 'To',
    'warehouse.transfers.items': 'Items',
    'warehouse.transfers.ship': 'Ship',
    'warehouse.transfers.markReceived': 'Mark as Received',
    'warehouse.transfers.pendingDescription': 'These transfers need action',
    'warehouse.forecast.title': 'Demand Forecasting',
    'warehouse.forecast.comingSoon': 'Coming soon',
    'warehouse.rebalancing.title': 'Inventory Rebalancing',
    'warehouse.rebalancing.createPlan': 'Create Rebalancing Plan',
    'warehouse.rebalancing.transfers': 'Transfers',
    'warehouse.rebalancing.estimatedCost': 'Estimated Cost',
    'warehouse.rebalancing.improvement': 'Improvement',
    'warehouse.rebalancing.execute': 'Execute Plan',
    'warehouse.rebalancing.noPlan': 'No rebalancing plan yet',
    'common.refresh': 'Refresh',

    // Fulfillment
    'fulfillment.title': 'Fulfillment Management',
    'fulfillment.dashboard': 'Fulfillment Dashboard',
    'fulfillment.dashboardDescription': 'Manage picking, packing, and shipping',
    ...
    'fulfillment.assignedTo': 'Assigned To',
    'fulfillment.priority': 'Priority',
    'fulfillment.noOrders': 'No orders',
    'fulfillment.searchPlaceholder': 'Search orders, products...',
    'fulfillment.statusOverview': 'Status Overview',
    'fulfillment.totalOrders': 'Total Orders',
    'fulfillment.ordersSummary': 'Orders Summary',
    'fulfillment.pickingList': 'Picking List',
    'fulfillment.shippingManager': 'Shipping Manager',
    'fulfillment.startPicking': 'Start Picking',
    'fulfillment.startPacking': 'Start Packing',
    'fulfillment.ship': 'Ship',
    'fulfillment.pickedBy': 'Picked By',
    'fulfillment.picked': 'Picked',
    'fulfillment.pick': 'Pick',
    'fulfillment.completePicking': 'Complete Picking',
    'fulfillment.pickingNotes': 'Picking Notes',
    'fulfillment.addNotes': 'Add Notes',
    'fulfillment.barcodeScanner': 'Barcode Scanner',
    'fulfillment.scanBarcode': 'Scan Barcode...',

    // Fulfillment Status
    'fulfillment.status.new': 'New',
    'fulfillment.status.payment_received': 'Payment Received',
    'fulfillment.status.readyForFulfillment': 'Ready for Fulfillment',
    'fulfillment.status.picking': 'Picking',
    'fulfillment.status.picked': 'Picked',
    'fulfillment.status.packing': 'Packing',
    'fulfillment.status.packed': 'Packed',
    'fulfillment.status.shipped': 'Shipped',
    'fulfillment.status.inTransit': 'In Transit',
    'fulfillment.status.outForDelivery': 'Out for Delivery',
    'fulfillment.status.delivered': 'Delivered',
    'fulfillment.status.returned': 'Returned',
    'fulfillment.status.cancelled': 'Cancelled',

    // Fulfillment Priority
    'fulfillment.priority.urgent': 'Urgent',
    'fulfillment.priority.high': 'High',
    'fulfillment.priority.normal': 'Normal',
    'fulfillment.priority.low': 'Low',

    // Fulfillment Metrics
    'fulfillment.metrics.totalOrders': 'Total Orders',
    'fulfillment.metrics.averagePickTime': 'Avg Pick Time',
    'fulfillment.metrics.pickAccuracy': 'Pick Accuracy',
    'fulfillment.metrics.onTimeShipment': 'On-Time Shipment',

    // Fulfillment Sort
    'fulfillment.sortBy.priority': 'Priority',
    'fulfillment.sortBy.date': 'Date',
    'fulfillment.sortBy.status': 'Status',

    // Fulfillment Picking
    'fulfillment.picking.barcodeNotFound': 'Barcode not found',

    // Shipping
    'fulfillment.shipping.fromAddress': 'From Address',
    'fulfillment.shipping.toAddress': 'To Address',
    'fulfillment.shipping.packageDetails': 'Package Details',
    'fulfillment.shipping.weight': 'Weight',
    'fulfillment.shipping.dimensions': 'Dimensions',
    'fulfillment.shipping.boxes': 'Boxes',
    'fulfillment.shipping.rates': 'Shipping Rates',
    'fulfillment.shipping.refreshRates': 'Refresh Rates',
    'fulfillment.shipping.noRates': 'No shipping rates available',
    'fulfillment.shipping.estimatedDelivery': 'Estimated Delivery',
    'fulfillment.shipping.guaranteed': 'Guaranteed',
    'fulfillment.shipping.insuranceAvailable': 'Insurance Available',
    'fulfillment.shipping.options': 'Shipping Options',
    'fulfillment.shipping.insurance': 'Insurance',
    'fulfillment.shipping.insuranceAmount': 'Insurance Amount',
    'fulfillment.shipping.signatureRequired': 'Signature Required',
    'fulfillment.shipping.saturdayDelivery': 'Saturday Delivery',
    'fulfillment.shipping.generateLabel': 'Generate Label',
    'fulfillment.shipping.generatingLabel': 'Generating Label...',
    'fulfillment.shipping.labelGenerated': 'Label Generated',
    'fulfillment.shipping.trackingNumber': 'Tracking Number',
    'fulfillment.shipping.downloadLabel': 'Download Label',
    'fulfillment.shipping.schedulePickup': 'Schedule Pickup',
    'fulfillment.shipping.pickupDate': 'Pickup Date',
    'fulfillment.shipping.pickupScheduled': 'Pickup Scheduled',
    'fulfillment.shipping.confirmationNumber': 'Confirmation Number',
    'fulfillment.shipping.markAsShipped': 'Mark as Shipped',
    'fulfillment.shipping.labelGenerationError': 'Error generating label',
    'fulfillment.shipping.pickupSchedulingError': 'Error scheduling pickup',

    // Tracking
    'fulfillment.tracking.title': 'Package Tracking',
    'fulfillment.tracking.trackingNumber': 'Tracking Number',
    'fulfillment.tracking.lastUpdated': 'Last Updated',
    'fulfillment.tracking.progress': 'Progress',
    'fulfillment.tracking.estimatedDelivery': 'Estimated Delivery',
    'fulfillment.tracking.timeline': 'Timeline',
    'fulfillment.tracking.noEvents': 'No tracking events',
    'fulfillment.tracking.map': 'Delivery Map',
    'fulfillment.tracking.mapPlaceholder': 'Delivery Map',
    'fulfillment.tracking.mapComingSoon': 'Coming Soon',
    'fulfillment.tracking.proofOfDelivery': 'Proof of Delivery',
    'fulfillment.tracking.deliveredAt': 'Delivered At',
    'fulfillment.tracking.deliveryLocation': 'Delivery Location',
    'fulfillment.tracking.signatureOnFile': 'Signature on File',
    'fulfillment.tracking.exception': 'Delivery Exception',
    'fulfillment.tracking.exceptionDetails': 'There was a problem with delivery. Please contact support.',
    'fulfillment.tracking.contactSupport': 'Contact Support',
    'fulfillment.tracking.shareTracking': 'Share Tracking',

    // Tracking Status
    'fulfillment.tracking.status.pre_transit': 'Pre-Transit',
    'fulfillment.tracking.status.in_transit': 'In Transit',
    'fulfillment.tracking.status.out_for_delivery': 'Out for Delivery',
    'fulfillment.tracking.status.delivered': 'Delivered',
    'fulfillment.tracking.status.returned': 'Returned',
    'fulfillment.tracking.status.exception': 'Exception',
    'fulfillment.tracking.status.cancelled': 'Cancelled',
